...
const consularApi = (ciudad, pais) => {
    const id = 'fe0fddaa3da0ee7884d72247564957b4';
...
const mostrarClima = (datos) => {
    ...
    actual.innerHTML = `Actual: ${ temperatura } &#8451`;
    actual.classList.add('font-bold', 'text-6xl');

    const tempMax = document.createElement('p');
    tempMax.innerHTML = `Maxima: ${ max } &#8451`;
    tempMax.classList.add('text-xl');

    const tempMin = document.createElement('p');
    tempMin.innerHTML = `Mínima: ${ min } &#8451`;
